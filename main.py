...
# Load model
os.system(f'wget -O {MODEL_PATH} "https://civitai.com/api/download/models/690310?type=Model&format=SafeTensor&size=full&fp=fp16&token=73d601e10c083237962ca2b4cbc17312"')
